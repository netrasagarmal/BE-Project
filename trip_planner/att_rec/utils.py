...
class Util(object):
    ...
    def read_data(self, folder):
        ...
        #ratings = pd.read_json(folder+"attraction_reviews.json",lines=True, orient='records')
        #attractions = pd.read_json(folder+"attractions.json",lines=True, orient='records')
        ...
        ratings = pd.read_json("D:/ITRS/etl/attraction_reviews.json", orient='records')
        attractions = pd.read_json("D:/ITRS/etl/attractions.json", orient='records')
